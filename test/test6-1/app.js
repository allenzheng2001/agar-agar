...
{
  images = [];
  images.push(loadImage('assets/forest.jpg'));
  images.push(loadImage('assets/ice.jpg'));
  images.push(loadImage('assets/lava.jpg'));
...
function setup() 
{
  ...
  world_biomes = new Biomes();
  world_biomes.initialize();
  setup_helper();
}
...
function keyPressed()
{
  ...
  {
    me.fix_move(createVector(0, 0), -1);
  }
  else if (key == 'a')
  {
    me.safe_on();
